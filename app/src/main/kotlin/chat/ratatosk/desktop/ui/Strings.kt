...
object Strings {
    ...
    val CHANNEL_ANNOUNCE_WHEN_OPEN = tr("Сообщить, когда откроется", "Tell me when it opens")
    val CHANNEL_ANNOUNCE_ASKED = tr("Сообщим, когда откроется", "We will tell you when it opens")
    val CHANNEL_OPENED_TITLE = tr("Канал открылся", "The channel has opened")
    val CHANNEL_OPENED_BODY = tr("«%s» открылся — можно читать", "%s is open — you can read it now")
    val CHANNEL_OPENED_BODY_PLAIN = tr("Канал, которого вы ждали, открылся", "A channel you were waiting for has opened")
